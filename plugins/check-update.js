...
malvin({
  ...
  try {
    ...
    // Remote version data
    const repoRawURL = 'https://raw.githubusercontent.com/MaskyOfficialTech/MASKY-XD_V2/main/data/version.json';
    ...
    const updateStatus = localVersion !== latestVersion
      ...
      : `✅ Your MASKY-XD bot is up-to-date!`;
...
👑 *Owner:* https://github.com/MaskyOfficialTech
